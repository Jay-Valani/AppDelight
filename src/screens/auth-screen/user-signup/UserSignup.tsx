...
export default function UserSignup(props: any) {
  ...
  const onSignupBtnClick = () => {
    ...
    } else if (passwordRegex.test(confirmPasswordInput) === false || confirmPasswordInput.length === 0) {
      Platform.OS == "android" ?
        ToastAndroid.show("Your confirm password must contain uppercase, lower case, number and special characters!", ToastAndroid.SHORT) :
        Alert.alert("Your confirm password must contain uppercase, lower case, number and special characters!")
      ...
      <KeyboardAvoidingView style={styles.bodyContainer}>
        <ScrollView>
          ...
          <CustomInput
            ...
            onInputChangeHandler={(text: any) => onConfirmPasswordInputChangeTxt(text)}
          />
        </ScrollView>
